...
class _AddProductScreenState extends State<AddProductScreen> {
 ...
 var ownershipCategoryType={'Owner':'O','Agent':'A',};
 ...
 String brokerage="";
 var brokerageAmount={'₹0':'O','50% Of Rent Amount':'A','₹500':'A','₹1000':'A','₹1500':'A','₹2000':'A','₹2500':'A', '₹3000':'A','₹3500':'A','₹4000':'A','₹5000':'A','₹6000':'A','₹8000':'A','₹10000':'A','₹12000':'A'};
            ...
            child: Column(
              ...
              children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.lato(
                              color: darkCreamColor.withOpacity(0.8), fontSize: 14, fontWeight: FontWeight.w600),
                        ),
                      ),
                      const SizedBox(
                        height: 5,
                ...
                const SizedBox(height: 10),
                   ...
                   DottedBorder( color: Colors.grey.shade200,
                     child: Padding(
                       ...
                       child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                         children: [
                           Padding(
                             padding: const EdgeInsets.only(left: 10),
                             child: Text("Are You Owner or Agent ?",  style: GoogleFonts.lato(
                                        color: darkCreamColor.withOpacity(0.8), fontSize: 15, fontWeight: FontWeight.w600),),
                           ),
                                       const SizedBox(height: 10,),
                                     Container(
                            decoration: BoxDecoration(
                            ...
                            child: DropdownButton(
                              ...
                              onChanged: (newValue){
                                setState(() {
                                  brokerageAmounts=[];
                                  stateDependentDropDown(ownershipCategoryType[newValue]);
                              ...
                              items:categories.map((ownershipCategoryType){
                                return DropdownMenuItem(
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(ownershipCategoryType,  style: TextStyle(
                                                        fontSize: 15,
                                                        color: Colors.grey.shade700),),
                                  ),
                                  value:ownershipCategoryType,
                                     ...
                                     const SizedBox(height: 10,),
                                       ...
                                       Padding(
                            padding: const EdgeInsets.only(left: 10),
                            child: Text("Brokerage in Rupees", style: GoogleFonts.lato(
                                       color: darkCreamColor.withOpacity(0.8), fontSize: 15, fontWeight: FontWeight.w600),),
                                       ),
                                       const SizedBox(height: 10),
                                     Container(
    ...
    // This trailing comma makes auto-formatting nicer for build methods.
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      labelText: "Address",
                      labelStyle: GoogleFonts.lato(color: darkCreamColor.withOpacity(0.8), fontSize: 18, fontWeight: FontWeight.w600),
